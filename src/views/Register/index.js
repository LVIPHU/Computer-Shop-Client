...
function SignUp() {
    ...
    const validationSchema = Yup.object().shape({
        ...
        verifyCode: Yup.string()
            ...
            .length(constants.MAX_VERIFY_CODE, `* Mã xác nhận có ${constants.MAX_VERIFY_CODE} ký tự`),
        password: Yup.string()
            .trim()
        ...
        confirmPassword: Yup.string().oneOf([Yup.ref('password'), null], '* Mật khẩu chưa trùng khớp'),
        birthday: Yup.date()
            .notRequired()
    ...
    return (
        <div className="SignUp container">
            ...
            <Formik initialValues={initialValue} validationSchema={validationSchema} onSubmit={onSignUp}>
                {(formikProps) => {
                    emailRef.current = formikProps.values.email;
                    const suffixColor = 'rgba(0, 0, 0, 0.25)';
                    return (
                        <Form className="bg-form">
                            <Row className="input-border" gutter={[64, 32]} style={{ margin: 0 }}>
                                ...
                                <Col span={24} className="p-t-0 t-center">
                                    ...
                                    <div className="m-t-10 font-weight-500">
                                        Bạn đã có tài khoản ?<Link to={constants.ROUTES.LOGIN}>&nbsp;Đăng nhập</Link>
                                    </div>
                                </Col>
                            </Row>
                        </Form>
