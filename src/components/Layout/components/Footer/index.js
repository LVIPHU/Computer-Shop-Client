        ...
        <div className="container-fluid bg-white footer p-lr-0" id="footer">
            ...
            <div className="container p-tb-32">
                <p className="t-center" style={{ color: '#888' }}>
                    <span className="font-size-18px">CÔNG TY CỔ PHẦN THƯƠNG MẠI - DỊCH VỤ TTB STORE</span>
                    <br />
                    <strong>Trụ sở:</strong>&nbsp;Số 16 VillaD, The Manor, khu đô thị mới Mỹ Đình Mễ Trì, Phường 1, Quận
                    12, Thành phố Hồ Chí Minh
                    <br />
                    <strong>Văn phòng:</strong>&nbsp; Tầng 16, Tòa Văn phòng, Vincom, số 54 Nguyễn Chí Thanh, Phường 5,
                    Quận 12, Thành phố Hồ Chí Minh
                    <br />
                    <strong>Điện&nbsp;thoại:</strong>&nbsp;0840.67.9081 | <strong>Email:</strong>
                    &nbsp;ttbstore@gmail.com&nbsp;| <strong>Website:</strong>&nbsp;<a href="/">ttbstore.vn</a>
                </p>
                <div className="d-flex align-i-center justify-content-center">
                    <img src={registeredImg} width={175} alt="registeredImg" />
                    <div className="d-flex align-i-center m-lr-32">
                        <img src={iconPhoneFooter} alt="iconPhoneFooter" />
                    ...
                    <div className="d-flex">
                        <a href="https://fb.com" target="blank">
                            <FacebookFilled className="p-lr-4 social-item" style={{ fontSize: 36, color: '#0C86EF' }} />
                        </a>
                        <a href="https://www.linkedin.com/">
                            <LinkedinFilled className="p-lr-4 social-item" style={{ fontSize: 36, color: '#0073B1' }} />
                        </a>
