...
import Evaluation from '@/views/Product/Evaluation';
        ...
        <div className="Product-Detail-View container m-t-20">
            <Row gutter={[16, 32]}>
                ...
                <Col span={24} className="d-flex page-position">
                    ...
                    <span className="pro-name p-8 font-weight-500 bg-white">{product.name}</span>
                </Col>
                ...
                <Col span={24}>
                    {/* <RelatedProduct title="Sản phẩm tương tự" type={type} brand={brand} id={_id} /> */}
                </Col>
            </Row>
        </div>
    );
